...
path1 = os.path.join(os.path.dirname(__file__), 'results', '3.png')
path2 = os.path.join(os.path.dirname(__file__), 'results', '4.png')
path3 = os.path.join(os.path.dirname(__file__), 'results', '5.png')
# path4 = os.path.join(os.path.dirname(__file__), 'results', '7.png')
...
# axs[3].imshow(img4)
# axs[3].set_title('Quadratic Lighting Correction')
for ax in axs:
